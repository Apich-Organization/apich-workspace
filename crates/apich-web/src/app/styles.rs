...
:root {
    ...
    --bg-muted: rgba(241, 245, 249, 0.75);
    --border-subtle: rgba(226, 232, 240, 0.8);
    --border-strong: rgba(203, 213, 225, 0.85);
    --border-focus: #2563eb;
    --border-glass: rgba(255, 255, 255, 0.9);
    --border-glass-tint: rgba(186, 230, 253, 0.5);
    ...
    --primary-gradient: linear-gradient(135deg, #0284c7 0%, #2563eb 55%, #3b82f6 100%);
    --accent-cyan: #0284c7;
    --accent-indigo: #4f46e5;
    --accent-violet: #7c3aed;

    --success: #16a34a;
    --success-bg: rgba(240, 253, 244, 0.85);
    --success-border: #bbf7d0;
    --warning: #d97706;
    --warning-bg: rgba(255, 251, 235, 0.85);
    --warning-border: #fde68a;
    --danger: #dc2626;
    --danger-bg: rgba(254, 242, 242, 0.85);
    ...
    --shadow-md: 0 4px 14px -2px rgba(37, 99, 235, 0.06), 0 2px 6px -1px rgba(15, 23, 42, 0.03);
    --shadow-lg: 0 12px 32px -4px rgba(37, 99, 235, 0.09), 0 4px 12px -2px rgba(14, 165, 233, 0.04);
...
@keyframes breathe-glow {
    0%, 100% {
        box-shadow: 0 8px 30px -4px rgba(37, 99, 235, 0.07), 0 2px 8px -1px rgba(14, 165, 233, 0.04);
    }
    50% {
        box-shadow: 0 12px 38px -2px rgba(37, 99, 235, 0.15), 0 4px 14px -1px rgba(56, 189, 248, 0.1);
    }
}
...
.app-sidebar {
    ...
    left: 0;
    z-index: 90;
    box-shadow: 2px 0 16px rgba(37, 99, 235, 0.04);
}
...
.project-card {
    ...
    box-shadow: var(--shadow-md);
    animation: subtle-fade-in 0.3s var(--ease-out-cubic);
}
.project-card:hover {
...
.btn-sm { font-size: 0.775rem; padding: 0.32rem 0.7rem; border-radius: var(--radius-xs); }
...
.auth-card {
    ...
    width: 100%;
    max-width: 460px;
    box-shadow: 0 16px 40px -6px rgba(37, 99, 235, 0.12), 0 4px 12px -2px rgba(15, 23, 42, 0.04);
...
.pill-typst { background: #eff6ff; color: #2563eb; border: 1px solid #bfdbfe; }
...
.pill-asset { background: #f8fafc; color: #64748b; border: 1px solid #e2e8f0; }
