...
"###;
        ...
        // 2. cargo-slide theme: theme.typ
        let theme_typ = r###"// APICH cargo-slide theme
#let slide-colors = (
  accent: rgb("#2563eb"),
...
"###;
        ...
        // 3. cargo-slide DSL component macros: slide.typ
        let slide_typ = r###"// APICH cargo-slide component macros
